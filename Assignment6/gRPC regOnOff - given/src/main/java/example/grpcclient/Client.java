...
public class Client {
  ...
  public static void main(String[] args) throws Exception {
    ...
    try {
      ...
      System.out.println("Enter from unit (e.g. CELSIUS, KILOMETER, POUND):");
      String fromUnit = reader.readLine();
      System.out.println("Enter to unit (e.g. FAHRENHEIT, MILE, KILOGRAM):");
      String toUnit = reader.readLine();

      client.askForConvert(Double.parseDouble(numStr), fromUnit, toUnit);
